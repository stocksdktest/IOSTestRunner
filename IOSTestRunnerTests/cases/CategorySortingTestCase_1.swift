...
class CategorySortingTestCase_1: BaseTestCase {
    
    override var stockTestCaseName: StockTestCaseName {
        return StockTestCaseName.CategorySortingTestCase_1
    }
    ...
    func testCategorySorting() {
        ...
        mRequest.cffSortingField = param["CFFSORTINGFIEID"].stringValue  //中金所排序列表

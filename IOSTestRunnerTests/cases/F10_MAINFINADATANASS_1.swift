...
//        XCTAssertNotNil(financialInfoResponse.jsonObject)
        if (financialInfoResponse.jsonObject == nil){
            throw BaseTestError.assertFailedError(message: "financialInfoResponse jsonObject is nil")
        }

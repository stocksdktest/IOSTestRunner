...
class QUOTEDETAILTCPTEST_1: BaseTestCase {
    
    override var stockTestCaseName: StockTestCaseName {
        return StockTestCaseName.QUOTEDETAILTCPTEST_1
    }
...
//        case .snap:
            ...
            if items is MStockItem{
                let item : MStockItem = items as! MStockItem
                var resultJSON: JSON = [
...
//                    "recentYearChangeRate": item.nYearChangeRate,
                ...
                do {
                    try resultJSON.merge(with: update55)
                } catch {
                    // ignore
                }
                var update56:JSON = [
                ...
                do {
                    try resultJSON.merge(with: update56)
                } catch {
                    // ignore
                }
